...
.method private decodeInlineMutationBatch(I[B)Lcom/google/firebase/firestore/model/mutation/MutationBatch;
    ...
    .line 459
    invoke-virtual {v4, v2}, Lcom/google/firebase/firestore/local/SQLitePersistence$Query;->first(Lcom/google/firebase/firestore/util/Consumer;)I
...
.method static synthetic lambda$getAllMutationBatches$6(Lcom/google/firebase/firestore/local/SQLiteMutationQueue;Ljava/util/List;Landroid/database/Cursor;)V
    .locals 2
...
.method static synthetic lambda$getAllMutationBatchesAffectingDocumentKey$7(Lcom/google/firebase/firestore/local/SQLiteMutationQueue;Ljava/util/List;Landroid/database/Cursor;)V
    .locals 2
...
.method static synthetic lambda$getAllMutationBatchesAffectingDocumentKeys$8(Lcom/google/firebase/firestore/local/SQLiteMutationQueue;Ljava/util/Set;Ljava/util/List;Landroid/database/Cursor;)V
    .locals 2
...
.method static synthetic lambda$getAllMutationBatchesAffectingQuery$10(Lcom/google/firebase/firestore/local/SQLiteMutationQueue;Ljava/util/List;ILandroid/database/Cursor;)V
    .locals 3
...
.method private loadNextBatchIdAcrossAllUsers()V
    ...
    .line 143
    invoke-virtual {v4, v2}, Lcom/google/firebase/firestore/local/SQLitePersistence$Query;->forEach(Lcom/google/firebase/firestore/util/Consumer;)I
...
.method public acknowledgeBatch(Lcom/google/firebase/firestore/model/mutation/MutationBatch;Lcom/google/protobuf/ByteString;)V
    ...
    iput-object p2, p0, Lcom/google/firebase/firestore/local/SQLiteMutationQueue;->lastStreamToken:Lcom/google/protobuf/ByteString;
...
.method public getAllMutationBatchesAffectingDocumentKey(Lcom/google/firebase/firestore/model/DocumentKey;)Ljava/util/List;
    ...
    invoke-static {p0, v0}, Lcom/google/firebase/firestore/local/SQLiteMutationQueue$$Lambda$8;->lambdaFactory$(Lcom/google/firebase/firestore/local/SQLiteMutationQueue;Ljava/util/List;)Lcom/google/firebase/firestore/util/Consumer;

    move-result-object p1

    .line 272
    invoke-virtual {v1, p1}, Lcom/google/firebase/firestore/local/SQLitePersistence$Query;->forEach(Lcom/google/firebase/firestore/util/Consumer;)I
...
.method public getAllMutationBatchesAffectingDocumentKeys(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-static {p0, v1, v0}, Lcom/google/firebase/firestore/local/SQLiteMutationQueue$$Lambda$9;->lambdaFactory$(Lcom/google/firebase/firestore/local/SQLiteMutationQueue;Ljava/util/Set;Ljava/util/List;)Lcom/google/firebase/firestore/util/Consumer;
    ...
    .line 318
    invoke-static {}, Lcom/google/firebase/firestore/local/SQLiteMutationQueue$$Lambda$10;->lambdaFactory$()Ljava/util/Comparator;
...
.method public getAllMutationBatchesAffectingQuery(Lcom/google/firebase/firestore/core/Query;)Ljava/util/List;
    ...
    invoke-static {p0, v4, v0}, Lcom/google/firebase/firestore/local/SQLiteMutationQueue$$Lambda$11;->lambdaFactory$(Lcom/google/firebase/firestore/local/SQLiteMutationQueue;Ljava/util/List;I)Lcom/google/firebase/firestore/util/Consumer;

    move-result-object p1

    .line 364
    invoke-virtual {v5, p1}, Lcom/google/firebase/firestore/local/SQLitePersistence$Query;->forEach(Lcom/google/firebase/firestore/util/Consumer;)I
...
.method public getNextMutationBatchAfterBatchId(I)Lcom/google/firebase/firestore/model/mutation/MutationBatch;
    ...
    .line 236
    invoke-virtual {v1, p1}, Lcom/google/firebase/firestore/local/SQLitePersistence$Query;->firstValue(Lcom/google/common/base/Function;)Ljava/lang/Object;
...
.method public performConsistencyCheck()V
    ...
    invoke-static {v0}, Lcom/google/firebase/firestore/local/SQLiteMutationQueue$$Lambda$12;->lambdaFactory$(Ljava/util/List;)Lcom/google/firebase/firestore/util/Consumer;
